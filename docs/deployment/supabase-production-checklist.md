...
Use email magic link / OTP for the first public test.
...
4. Enter an email and receive the magic-link email.
5. Open the magic link and return to FOUND CAT signed in.
